      ...
      <div className={styles.container}>
        ...
        <div className={styles.mainContent}>
          <div className={styles.leftColumn}>
            ...
            <div className={styles.desktopCtaButtons}>
              {/* Social Media Button */}
              <button 
                className={`${styles.ctaButtonMobile} ${styles.socialButton}`}
                onClick={() => setActivePopup('social')}
              >
                <span className={styles.ctaIconMobile}>📱</span>
                <span className={styles.ctaTextMobile}>Social Media</span>
              </button>

              {/* PDF Downloads Button */}
              <button 
                className={`${styles.ctaButtonMobile} ${styles.guidesButton}`}
                onClick={() => setActivePopup('guides')}
              >
                <span className={styles.ctaIconMobile}>📚</span>
                <span className={styles.ctaTextMobile}>Guide PDF</span>
              </button>

              {/* About Me Button */}
              <button 
                className={`${styles.ctaButtonMobile} ${styles.aboutButton}`}
                onClick={() => setActivePopup('info')}
              >
                <span className={styles.ctaIconMobile}>👨‍💼</span>
                <span className={styles.ctaTextMobile}>Su di me</span>
              </button>
            </div>
          </div>
          ...
          <div className={styles.textSection}>
            <p className={styles.aboutText}>
             ...
             <br></br> Mi chiamo Mauro Simoncini,
              ...
              <br></br><br></br><strong>Non applico direttamente i prodotti, ma ti aiuto a capire come funzionano, quando, come e se usarli.<br />
        ...
        <div className={styles.bottomGridSection}>
          <div className={styles.bottomGrid}>
            ...
            >
              <span className={styles.ctaIconMobile}>📱</span>
              <span className={styles.ctaTextMobile}>Social</span>
            </button>
